...
| REQ-LAB-017 | Lab-only security testing | docs/security | Pending IDS suite |
...
| REQ-LAB-022 | HIL closed-loop | `tests/hil` | **Open** |
| REQ-LAB-023 | Fault injection framework | `tests/fault_injection` | **Open** |
| REQ-LAB-024 | CAN IDS service | future `platform/services` | **Open** |
